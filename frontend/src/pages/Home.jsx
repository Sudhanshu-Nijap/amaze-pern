                ...
                <div className="row align-items-center">
                    <div className="col-12 col-md-5">
                        ...
                        <div className="d-flex gap-3 flex-wrap mt-4">
                            <Link to="/register" className="btn-orange text-decoration-none" style={{ width: 'fit-content' }}>Sign up for free</Link>
                            <a href="/amaze-extension.zip" download className="btn btn-outline-dark fw-bold" style={{ width: 'fit-content', borderRadius: '50px', padding: '10px 24px' }}>
                                <i className="bi bi-browser-chrome me-2"></i>Download Extension
                            </a>
                        </div>
                    </div>
